...
from code import class_diagram, config_to_config_file
import os

# load ui file
baseUIClass, baseUIWidget = uic.loadUiType("./code/ui/edit_config_file.ui")
...
class Logic(baseUIWidget, baseUIClass):
    ...
    def update_config(self):
        ...
        config.template_file = self.selected_template_edit.displayText()
